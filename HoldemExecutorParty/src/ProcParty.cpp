...
void ProcParty::setImage(const QImage & img)
{
   delete matrix_;
   matrix_ = 0;
...
QPair<QRect, QRect> ProcParty::getHoleCards(bool * ok)
{
...
bool ProcParty::checkHueButton(const QImage & imgBtn, int minHue, int maxHue, int rectMin)
{
